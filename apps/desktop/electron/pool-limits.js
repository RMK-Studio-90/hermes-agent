 ...
 */
export const POOL_LIMITS_DEFAULTS = {
    maxBackends: 3,
    idleMs: 10 * 60_000
};
/** Hard floors — match the clamps the env-var path always applied. */
export const POOL_LIMITS_MIN = {
    maxBackends: 1,
    idleMs: 60_000
};
...
export function clampPoolLimits(raw) {
...
export function parsePoolLimits(json) {
    if (!json) {
