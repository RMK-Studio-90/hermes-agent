...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("snapshot", "Create or restore state snapshots of Hermes config/state", "Session",
               ...
               desktop="terminal"),
    CommandDef("rmk-safestate", "RMK SafeState: game-style save point with code/routing verification",
               "Session", cli_only=True, args_hint="[create [label]|verify [id]|restore <id> [--dry-run]|list]"),
    ...
    CommandDef("graph", "Clarify a task, preview its execution graph, then approve and run", "Session",
               args_hint="<task> | status | start <token> | cancel", argument_mode="mixed",
               subcommands=("status", "start", "cancel")),
