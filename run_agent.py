...
class AIAgent(
    ...
    def _spawn_background_review_now(self, messages_snapshot: List[Dict], review_memory: bool = False,
                                     ...
                                     task_cfg: Optional[Dict[str, Any]] = None, explicit: bool = False,
                                     _requeue_attempts: int = 0) -> None:
        ...
        try:
            ...
            def _target_with_requeue() -> None:
                ...
                self._maybe_requeue_preempted_review(review_run, dict(
                    ...
                    focus=focus, task_cfg=task_cfg, explicit=explicit, _requeue_attempts=_requeue_attempts + 1))
